...
const NavPinkButton = ({ text, url }: IProp) => {
  return (
    <a href={url} target="_blank">
      <div className="relative  py-1 md:flex justify-end flex-row items-center text-left text-black z-[100]">
        <CopyButtonBg className="md:absolute relative block h-full lg:left-[-55%] top-0 z-[99]" />
        <p className="absolute md:static top-[3%] -right-[15%] z-[100] text-stroke-1-black  mr-[32%] lg:mr-[19%] py-4 text-xs lg:text-lg font-broad">
          {text}
        </p>
      </div>
    </a>
...
const CopyButtonBg = ({ className }: IProp) => (
  <svg
    viewBox="0 0 305 91"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className={`${className} w-36 lg:w-44`}
  >
    <mask
