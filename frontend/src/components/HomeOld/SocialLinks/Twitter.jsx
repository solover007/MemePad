...
import { PURPLE_PRIMARY_COLOR, TWITTER_USERNAME } from "@/lib/utils/constants";

const Twitter = ({ color }) => {
  return (
    <a
      className={`z-50 flex items-center gap-1 font-bold text-${color} transition-all duration-200 hover:cursor-pointer hover:text-[${PURPLE_PRIMARY_COLOR}]`}
