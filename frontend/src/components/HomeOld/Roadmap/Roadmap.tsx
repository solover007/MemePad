      ...
      <div className="p-4 relative flex justify-center items-center w-full scale-75 xl:scale-90 2xl:scale-100">
        <div className="size-[768px] relative flex justify-center items-center">
          ...
          <Image
            ...
            src="/icons/ellipse-around-roadmap.svg"
          ...
          <Image
            ...
            height={500}
            // src={ArrowOneRoadmap}
            src="/icons/arrow-one-roadmap.svg"
          ...
          <Image
            ...
            height={500}
            // src={ArrowTwoRoadmap}
            src="/icons/arrow-two-roadmap.svg"
