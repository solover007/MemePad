...
const Solana = ({ font, text, design }) => {
  ...
  return (
    ...
    >
      ...
      <p
        className={`font-${font} ${
          design === "one" ? "md:left-2" : "md:left-6"
        } absolute ml-2 md:ml-0 text-black text-stroke-1-black -top-5 md:-top-4 font-bold md:text-[19px] whitespace-nowrap text-left z-50`}
      >
        {text}
      </p>
    </button>
